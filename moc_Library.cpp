...
QT_MOC_LITERAL(1, 8, 10), // "updateList"
QT_MOC_LITERAL(2, 19, 0), // ""
QT_MOC_LITERAL(3, 20, 37), // "QList<std::shared_ptr<Abstrac..."
QT_MOC_LITERAL(4, 58, 7), // "newList"
QT_MOC_LITERAL(5, 66, 14) // "updateOnDelete"

    },
    "Library\0updateList\0\0"
    "QList<std::shared_ptr<AbstractItem> >\0"
    "newList\0updateOnDelete"
};
...
void Library::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        (void)_t;
        switch (_id) {
        case 0: _t->updateList((*reinterpret_cast< const QList<std::shared_ptr<AbstractItem> >(*)>(_a[1]))); break;
        case 1: _t->updateOnDelete((*reinterpret_cast< const QList<std::shared_ptr<AbstractItem> >(*)>(_a[1]))); break;
        default: ;
        }
    } else if (_c == QMetaObject::IndexOfMethod) {
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            using _t = void (Library::*)(const QList<std::shared_ptr<AbstractItem>> & );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Library::updateList)) {
                *result = 0;
                return;
            }
        }
        {
            using _t = void (Library::*)(const QList<std::shared_ptr<AbstractItem>> & );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Library::updateOnDelete)) {
                *result = 1;
                return;
            }
        }
...
// SIGNAL 0
void Library::updateList(const QList<std::shared_ptr<AbstractItem>> & _t1)
{
...
// SIGNAL 1
void Library::updateOnDelete(const QList<std::shared_ptr<AbstractItem>> & _t1)
{
    void *_a[] = { nullptr, const_cast<void*>(reinterpret_cast<const void*>(std::addressof(_t1))) };
