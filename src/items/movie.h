...
public:
	Movie(std::string _title, unsigned int _year, std::string _description, std::string _genre, std::string _country, const std::string _image, std::string _director, std::string _screenwriter, unsigned int length, std::string _production_company);
