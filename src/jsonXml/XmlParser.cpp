...
std::shared_ptr<AbstractItem> XmlParser::parseAlbum(QXmlStreamReader& xmlReader) {
    ...
    return std::make_shared<Album>(title.toStdString(), year, description.toStdString(), genre.toStdString(),
...
std::shared_ptr<AbstractItem> XmlParser::parseBook(QXmlStreamReader& xmlReader) {
    ...
    return std::make_shared<Books>(title.toStdString(), year, description.toStdString(), genre.toStdString(),
...
std::shared_ptr<AbstractItem> XmlParser::parseComic(QXmlStreamReader& xmlReader) {
    ...
    return std::make_shared<Comic>(title.toStdString(), year, description.toStdString(), genre.toStdString(),
...
std::shared_ptr<AbstractItem> XmlParser::parseMovie(QXmlStreamReader& xmlReader) {
    ...
    return std::make_shared<Movie>(title.toStdString(), year, description.toStdString(), genre.toStdString(),
...
std::shared_ptr<AbstractItem> XmlParser::parseVideogame(QXmlStreamReader& xmlReader) {
    ...
    return std::make_shared<Videogames>(title.toStdString(), year, description.toStdString(), genre.toStdString(),
