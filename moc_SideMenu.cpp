...
QT_MOC_LITERAL(3, 26, 8) // "category"

    },
    "SideMenu\0categoryChanged\0\0category"
};
...
void SideMenu::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            using _t = void (SideMenu::*)(const QString & );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&SideMenu::categoryChanged)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void SideMenu::categoryChanged(const QString & _t1)
{
